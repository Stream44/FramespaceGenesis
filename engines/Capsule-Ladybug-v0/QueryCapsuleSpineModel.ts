export async function capsule({
    ...
    return encapsulate({
            ...
            '#': {
                    ...
                    value: {
                        ...
                        methods: {
                            listCapsules: {
                                ...
                                discovery: 'Workbench/listSpineInstances',
                                filterField: '$id',
                            },
                            getCapsule: {
                                args: [
                ...
                listCapsules: {
                    ...
                    value: async function (this: any, conn: any, spineInstanceUri?: string, resolveRefs?: boolean): Promise<any> {
                        ...
                        const rows = await this.importer.queryAll(conn, query)
                ...
                getCapsuleSpineTree: {
                    ...
                    value: async function (this: any, conn: any, spineInstanceUri: string, includeProperties?: boolean): Promise<any | null> {
                        ...
                        const capsuleRows = await this.importer.queryAll(conn,
                ...
                _buildCapsuleEntity: {
                    ...
                    value: async function (this: any, conn: any, capsuleNode: any, sourceNode: any): Promise<any> {
                        ...
                        const allRows = await this.importer.queryAll(conn, `
        ...
        capsuleName: '@stream44.studio/FramespaceGenesis/engines/Capsule-Ladybug-v0/QueryCapsuleSpineModel',
    })
}
