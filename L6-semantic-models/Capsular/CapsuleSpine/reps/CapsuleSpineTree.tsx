...
import type { JsonObject, JsonValue, RepContext } from "../../../../L13-workbench/vinxi-app/src/lib/renderLib";
import type { WorkbenchLib } from "../../../../L13-workbench/vinxi-app/src/lib/workbenchLib";
...
function renderCompoundNodes(container: HTMLElement, data: JsonObject, spineInstanceUri: string | undefined, cytoscape: any) {
...
function renderTree(container: HTMLElement, data: JsonObject, spineInstanceUri: string | undefined, cytoscape: any) {
    const nodeMeta = precomputeNodeMeta(data);
...
function createCyRenderer(
    renderFn: (container: HTMLElement, data: JsonObject, spineInstanceUri: string | undefined, cytoscape: any) => any,
    data: JsonObject,
    spineInstanceUri: string | undefined,
    cytoscape: any,
) {
    ...
    function initCy() {
        ...
        initialized = true;
        cy = renderFn(cyContainer, data, spineInstanceUri, cytoscape);
...
registerRep({
    ...
    render: (data: JsonObject, ctx: RepContext): JSX.Element => {
        ...
        let dockview: any;
        const lib = ctx.lib!;
        const { DockviewComponent } = lib.dockviewCore;
        const themeBlueprintVellum = { name: "blueprint-vellum", className: "dockview-theme-blueprint-vellum", gap: 4 };
        ...
        onMount(() => {
            ...
            dockview = new DockviewComponent(containerRef, {
                ...
                createComponent: (options: any) => {
                    switch (options.name) {
                        case "tree":
                            return createCyRenderer(renderTree, data, ctx.spineInstanceUri, lib.cytoscape);
                        case "compound-nodes":
                        default:
                            return createCyRenderer(renderCompoundNodes, data, ctx.spineInstanceUri, lib.cytoscape);
                    }
                },
            });
