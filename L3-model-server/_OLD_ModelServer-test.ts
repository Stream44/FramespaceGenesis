...
describe('ModelServer Capsule', () => {
    ...
    it('starts the server via capsule', async () => {
        const result = await modelServer.startServer(port)
    ...
    it('GET /api/schema returns OpenAPI-style schema with endpoints and arg definitions', async () => {
        ...
        expect(data.endpoints['/api/Encapsulate/CapsuleSpine/getSpineDeclarationTree']).toBeDefined()
        expect(data.endpoints['/api/Encapsulate/CapsuleSpine/getSpineInstanceTree']).toBeDefined()
        ...
        // Workbench endpoints
        expect(data.endpoints['/api/Framespace/Workbench/listSpineInstanceTrees']).toBeDefined()
    ...
    it('GET /api/Framespace/Workbench/listSpineInstanceTrees returns instances', async () => {
        const res = await fetch(`${BASE_URL}/api/Framespace/Workbench/listSpineInstanceTrees`)
        expect(res.status).toBe(200)
        const data = await res.json() as any
    ...
    it('GET /api/Encapsulate/CapsuleSpine/getSpineDeclarationTree with no args falls back to listSpineInstanceTrees', async () => {
        const res = await fetch(`${BASE_URL}/api/Encapsulate/CapsuleSpine/getSpineDeclarationTree`)
        expect(res.status).toBe(200)
        const data = await res.json() as any
        expect(data.fallbackFrom).toBe('getSpineDeclarationTree')
        expect(data.method).toBe('listSpineInstanceTrees')
        expect(data.result).toBeDefined()
    })
