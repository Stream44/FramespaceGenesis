                ...
                importSitFile: {
                    ...
                    value: async function (this: any, sitFilePath: string): Promise<{ imported: number; capsules: number; instances: number }> {
                        ...
                        for (const capsuleName of capsuleNames) {
                            ...
                            // Fallback: strip first 2 segments (org/package) to get local path
                            ...
                            if (existsSync(uriCstFilePath)) {
                                ...
                                if (this.verbose) console.log(`[memory] CST file not found: ${uriCstFilePath} or ${localCstFilePath} or ${npmCstFilePath}`)
                                continue
                            }
