...
The workbench hosts all visual models and connectes them with the backend model engine which provides REST apis to query the graph model.
...
- [x] [SolidJS](https://www.solidjs.com/) renderers for schema entities called **Reps** ([object] Representations)
  - [x] Hardcoded reps for encapsulate model
...
(c) 2026 [Christoph.diy](https://christoph.diy) • Code: [LGPL](./LICENSE.txt) • Text: [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/)
